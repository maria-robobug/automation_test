Given(/^I navigate to the (.*) page$/) do |page_name|
  @image_flip_home_page = create_page page_name, @browser, nil
...
And(/^I generate the '(.*)' meme:$/) do |meme_type, table|
  ...
  @image_flip_meme_generator_page = create_page "ImageFlip Meme Generator", @browser, nil
...
Then(/^I should see the expected meme descriptions$/) do
  @image_flip_image_page = create_page "ImageFlip Image", @browser, @image_link
